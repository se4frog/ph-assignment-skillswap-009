        ...
        <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center px-6 py-12">
            ...
            <div className="text-center space-y-6 max-w-md">
                ...
                <div className="flex flex-col gap-4 justify-center pt-6">
                    ...
                    <Link
                        to="/auth/signup"
                        className="btn bg-white text-black hover:bg-yellow-500 hover:text-black rounded-none px-8 gap-2 border-none uppercase tracking-widest text-xs font-bold transition-colors"
                    >
