            ...
            <section className="min-h-[50vh] flex items-center justify-center overflow-hidden bg-transparent text-slate-200">
                ...
                <div className="relative z-10 text-center px-4 max-w-3xl">
                    ...
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <img
                            ...
                            className={`w-40 rounded-full
                                    ${animate ? 'animate__animated animate__bounce animate__shakeX animate__shakeY animate__fast' : ''
                                }`}
                        />
                    ...
                    <div className="mt-8 flex justify-center">
                        <button onClick={handleAnimate} className="
                        rounded-full bg-[#fae502] px-8 py-3 text-base font-semibold text-black transition-all duration-300 hover:shadow-[0_0_25px_rgba(34,211,238,0.5)]">
                            Explore Skills
                        </button>
                    </div>
